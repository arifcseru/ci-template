...
class Adminpanel extends BaseController
{
    ...
    {   
        ...
        if ($userPreference == null) {
            ...
            $data['loginUser'] = $this->name;
            $this->global['pageTitle'] = 'User Preference Needed!!!';
            $this->global['pageName'] = 'dashboard';
            ...
            $this->loadMaterialViews("admin/dashboard", $this->global, NULL , NULL);
        }
    }
    ...
    function userListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'Seesharp : User Listing';
    ...
    function addNew()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Seesharp : Add New User';
    ...
    function editOld($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Seesharp : Edit User';
    ...
    {
        $this->global['pageTitle'] = 'Seesharp : 404 - Page Not Found';
    ...
    function loginHistoy($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Seesharp : User Login History';
    ...
    function profile($active = "details")
    {
        ...
        $this->global['pageTitle'] = $active == "details" ? 'Seesharp : My Profile' : 'Seesharp : Change Password';
