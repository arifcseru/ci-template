<!-- /**
 * Class : jobApplicationList (jobApplicationForm List)
										...
										<td>
											<div class="form-group">
												...
												<?php
															...
															?>
													<button class="btn btn-success btn-sm" onclick="approveJobApplication(<?php echo $record->id; ?>)"><i class="fa fa-check"></i></button>
												<?php
														}
														?>

												<button class="btn btn-info btn-sm" onclick="loadJobApplicationFormUIToView(<?php echo $record->id; ?>)"><i class="fa fa-eye"></i></button>
												<button class="btn btn-warning btn-sm" onclick="loadJobApplicationFormUIToEdit(<?php echo $record->id; ?>)"><i class="fa fa-pencil"></i></button>
												...
												<button class="btn btn-danger btn-sm" onclick="deleteJobApplication(<?php echo $record->id; ?>)"><i class="fa fa-trash"></i></button>
											</div>
...
<script type="text/javascript">
	jQuery(document).ready(function() {
		jQuery('ul.pagination li a').click(function(e) {
			...
			//jQuery("#searchList").attr("action", baseURL + "jobApplicationList/" + value);
