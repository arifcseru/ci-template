<!-- /**
 * Class : holidayList (holidayForm List)
 * Holiday Actions
...
<td><?php echo $record->thruDate ?></td>
										...
										<td>
											<div class="form-group">
												...
												<button class="btn btn-info btn-sm" onclick="loadHolidayFormUIToView(<?php echo $record->id; ?>)"><i class="fa fa-eye"></i></button>
												<button class="btn btn-warning btn-sm" onclick="loadHolidayFormUIToEdit(<?php echo $record->id; ?>)"><i class="fa fa-pencil"></i></button>
												...
												<button class="btn btn-danger btn-sm" onclick="deleteHoliday(<?php echo $record->id; ?>)"><i class="fa fa-trash"></i></button>
											</div>
...
<script type="text/javascript">
	jQuery(document).ready(function() {
		jQuery('ul.pagination li a').click(function(e) {
			...
			//jQuery("#searchList").attr("action", baseURL + "holidayList/" + value);
