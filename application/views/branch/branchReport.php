...
<head>
	<title><?php echo $this->lang->line('content_branchListReport_label'); ?></title>
	<meta charset="utf-8">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="header">
								...
								<h4><?php echo $this->lang->line('content_branchReportHeader_label'); ?></h4>
...
<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group bmd-form-group">
									<label class="bmd-label-floating"><?php echo $this->lang->line('content_branch_establishedDate_label'); ?></label> 
