...
<div class="main-panel">
	...
	<!-- End Navbar -->
	<div class="content">
		<div class="container-fluid" id="branchContainer">
			<div class="row">
				<div class="col-md-12">
					<div class="card">
													...
													<td>
														<div class="form-group">
															...
															<?php
																		...
																		?>
																<button class="btn btn-success btn-sm" onclick="approveBranch(<?php echo $record->id; ?>)">
															...
															<button class="btn btn-info btn-sm" onclick="loadBranchFormUIToView(<?php echo $record->id; ?>)">
																<i class="fa fa-eye"></i>
															</button>
															<button class="btn btn-warning btn-sm" onclick="loadBranchFormUIToEdit(<?php echo $record->id; ?>)">
															...
															<button class="btn btn-danger btn-sm" onclick="deleteBranch(<?php echo $record->id; ?>)">
...
<script src="<?php echo base_url(); ?>js/branch/branchNavigations.js" type="text/javascript"></script>
