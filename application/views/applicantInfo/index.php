...
<div class="main-panel">
	...
	<!-- End Navbar -->
	<div class="content">
		<div class="container-fluid" id="applicantInfoContainer">
			<div class="row">
				<div class="col-md-12">
					<div class="card">
													...
													<td>
														<div class="form-group">
															...
															<?php
																		...
																		?>
																<button class="btn btn-success btn-sm" onclick="approveApplicantInfo(<?php echo $record->id; ?>)">
															...
															<button class="btn btn-info btn-sm" onclick="loadApplicantInfoFormUIToView(<?php echo $record->id; ?>)">
																<i class="fa fa-eye"></i>
															</button>
															<button class="btn btn-warning btn-sm" onclick="loadApplicantInfoFormUIToEdit(<?php echo $record->id; ?>)">
															...
															<button class="btn btn-danger btn-sm" onclick="deleteApplicantInfo(<?php echo $record->id; ?>)">
