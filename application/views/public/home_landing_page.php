...
<html class="full-height" lang="en-US">
  <head>
    ...
    <link href="material_landing_theme/css/mdb.min.css" rel="stylesheet">
    <link href="material_landing_theme/styles/main.css" rel="stylesheet">
  </head>
  <body id="top">
    <header>
      <!-- Navbar-->
...
<section class="py-5" id="projects">
  <div class="container">
    ...
    <div class="row wow fadeInLeft" data-wow-delay=".3s">
      <div class="col-lg-6 col-xl-5 pr-lg-5 pb-5"><img class="material_landing_theme/img-fluid rounded z-depth-2" src="material_landing_theme/img/kuala-lumpur.jpg" alt="project image"/></div>
    ...
    <div class="row pt-5 wow fadeInRight" data-wow-delay=".3s">
      ...
      <div class="col-lg-6 col-xl-5 mb-3"><img class="material_landing_theme/img-fluid rounded z-depth-2" src="material_landing_theme/img/san-francisco.jpg" alt="project image"/></div>
    </div>
  </div>
</section>
...
<section id="contact" style="background-image:url('img/panorama-3094696_1920.jpg');">
  <div class="rgba-black-strong py-5">
    ...
    <script type="text/javascript" src="material_landing_theme/js/jquery-3.2.1.min.js"></script>
    <script type="text/javascript" src="material_landing_theme/js/popper.min.js"></script>
    <script type="text/javascript" src="material_landing_theme/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="material_landing_theme/js/mdb.min.js"></script>
