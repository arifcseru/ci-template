...
<div class="main-panel">
	...
	<nav
		...
		<div class="container-fluid">
			<div class="navbar-wrapper">
				<a class="navbar-brand" href="<?php echo base_url(); ?>attendance">Admin
					Panel >> Attendance</a>
			</div>
	...
	<!-- End Navbar -->
	<div class="content">
		<div class="container-fluid" id="attendanceContainer">
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						...
						<div class="card-header card-header-info">
							...
							<div class="form-group pull-right">
								<button class="btn btn-info btn-sm" onclick="loadAttendanceFormUI()">
...
<td><?php echo $record->attendanceTime ?></td>
                            ...
                            if ($record->isApproved == "1") {
                                ...
                                ?>
											<button class="btn btn-success btn-sm"
														onclick="approveAttendance(<?php echo $record->id;?>)">
                            ...
                            ?>
											...
											<button class="btn btn-info btn-sm" onclick="loadAttendanceFormUIToView(<?php echo $record->id;?>)">
														<i class="fa fa-eye"></i>
													</button>
													<button class="btn btn-warning btn-sm"
														onclick="loadAttendanceFormUIToEdit(<?php echo $record->id;?>)">
...
<script
	src="<?php echo base_url(); ?>js/attendance/attendanceActions.js"
	type="text/javascript"></script>
<script
	src="<?php echo base_url(); ?>js/attendance/attendanceNavigations.js"
	type="text/javascript"></script>
