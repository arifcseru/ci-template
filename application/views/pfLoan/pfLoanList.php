<!-- /**
 * Class : pfLoanList (pfLoanForm List)
 * Pf Loan Actions
											...
											<div class="form-group">
												...
												<?php if ($role != null && $role == ROLE_APPROVER_ADMIN) {
													...
													<?php
																	...
																	?>
														<button class="btn btn-success btn-sm" onclick="approvePfLoan(<?php echo $record->id; ?>)"><i class="fa fa-check"></i></button>
												<?php
															}
														}
														?>

												<button class="btn btn-info btn-sm" onclick="loadPfLoanFormUIToView(<?php echo $record->id; ?>)"><i class="fa fa-eye"></i></button>
												<button class="btn btn-warning btn-sm" onclick="loadPfLoanFormUIToEdit(<?php echo $record->id; ?>)"><i class="fa fa-pencil"></i></button>
												...
												<button class="btn btn-danger btn-sm" onclick="deletePfLoan(<?php echo $record->id; ?>)"><i class="fa fa-trash"></i></button>
											</div>
...
<script type="text/javascript">
	jQuery(document).ready(function() {
		jQuery('ul.pagination li a').click(function(e) {
			...
			//jQuery("#searchList").attr("action", baseURL + "pfLoanList/" + value);
