...
<div class="main-panel">
	...
	<!-- End Navbar -->
	<div class="content">
		<div class="container-fluid" id="employeeContainer">
			<div class="row">
				<div class="col-md-12">
					<div class="card">
													...
													<td>
														<div class="form-group">
															...
															<?php
																		...
																		?>
																<button class="btn btn-success btn-sm" onclick="approveEmployee(<?php echo $record->id; ?>)">
															...
															<button class="btn btn-info btn-sm" onclick="loadEmployeeFormUIToView(<?php echo $record->id; ?>)">
																<i class="fa fa-eye"></i>
															</button>
															<button class="btn btn-warning btn-sm" onclick="loadEmployeeFormUIToEdit(<?php echo $record->id; ?>)">
															...
															<button class="btn btn-danger btn-sm" onclick="deleteEmployee(<?php echo $record->id; ?>)">
...
<script src="<?php echo base_url(); ?>js/employee/employeeNavigations.js" type="text/javascript"></script>
