...
<div class="row">
	<div class="col-md-8">
		<div class="card">
			...
			<div class="card-body">
				<!-- form role="form" action="<?php echo base_url() ?>role/create"
					method="post" id="createRole" role="form"-->
...
<div class="row">
					...
					if ($isApproved==null ||$isApproved=="" || $isApproved == "0") {
						?>
						<button onclick="saveRole()" class="btn btn-success pull-right"><?php echo $this->lang->line('content_save_label'); ?></button>
						<button onclick="loadRoleListUI()" class='btn btn-warning pull-left'> <?php echo $this->lang->line('content_cancel_label'); ?></button>
					<?php
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<?php
									...
									?>
							<button class="btn btn-success" onclick="approveRole(<?php echo $id; ?>)"><?php echo $this->lang->line('content_approve_label'); ?></button>
						<?php
								}
								?>
						<button class="btn btn-danger" onclick="deleteRole(<?php echo $id; ?>)"><?php echo $this->lang->line('content_delete_label'); ?></button>
					</div>
