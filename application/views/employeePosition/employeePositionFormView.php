<!-- /**
 * Class : employeePositionFormView (employeePositionForm View)
...
<div class="row">
	<div class="col-md-8">
		...
		<div class="card-header card-header-info">
			...
			<div class="card-body">
				<!-- form role="form" action="<?php echo base_url() ?>employeePosition/create" method="post" id="createEmployeePosition" role="form"-->
...
<div class="row">
					...
					<button class="btn btn-success" onclick="loadEmployeePositionFormUIToEdit(<?php echo $id; ?>)"><?php echo $this->lang->line('content_edit_label'); ?></button>
					<button class='btn btn-warning' onclick="loadEmployeePositionListUI()"> <?php echo $this->lang->line('content_cancel_label'); ?></button>
	...
	<div class="col-md-4">
		...
		<?php if ($id != null) {
			...
			<!-- div class="card">
						...
						<div class="card-body">
							 <a class="btn btn-success" onclick="return confirm('Are you sure?')" href="<?php echo base_url() . 'employeePosition/approve/' . $id; ?>">Approve</a>
                             <a class="btn btn-danger" onclick="return confirm('Are you sure?')" href="<?php echo base_url() . 'employeePosition/delete/' . $id; ?>">Delete</a>
                         </div>
					</div-->
		<?php } ?>
	</div>
