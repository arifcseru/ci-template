		...
		<div class="card">
			...
			<div class="card-header card-header-info">
				...
				<div class="form-group pull-right">
					<button class="btn btn-info btn-sm" onclick="loadEntityNameFormUI()"><i class="fa fa-plus"></i> Add New</button>
...
<td><?php echo $record->number ?></td>
                            ...
                            if ($record->isApproved == "1") {
                                ...
                                ?>
											<button class="btn btn-success btn-sm"  onclick="approveEntityName(<?php echo $record->id;?>)"><i class="fa fa-check"></i></button>
											<?php
                            }
                            ?>
											
											<button class="btn btn-info btn-sm" onclick="loadEntityNameFormUIToView(<?php echo $record->id;?>)"><i class="fa fa-eye"></i></button> 
											<button class="btn btn-warning btn-sm" onclick="loadEntityNameFormUIToEdit(<?php echo $record->id;?>)"><i class="fa fa-pencil"></i></button> 
											...
											<button class="btn btn-danger btn-sm" onclick="deleteEntityName(<?php echo $record->id;?>)"><i class="fa fa-trash"></i></button>
									</div>
