<!-- /**
 * Class : departmentList (departmentForm List)
 * Department Actions
...
<head>
    <title><?php echo $this->lang->line('content_departmentReport_label'); ?></title>
    <meta charset="utf-8">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="header">
                    ...
                    <h4><?php echo $this->lang->line('content_departmentListReportHeader_label'); ?> </h4>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
            jQuery('ul.pagination li a').click(function(e) {
                ...
                jQuery("#searchList").attr("action", baseURL + "departmentList/" + value);
