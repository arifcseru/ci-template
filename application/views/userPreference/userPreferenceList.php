<!-- /**
 * Class : userPreferenceList (userPreferenceForm List)
											...
											<div class="form-group">
												...
												<?php if ($role != null && $role == ROLE_APPROVER_ADMIN) {
													...
													<?php
																	...
																	?>
														<button class="btn btn-success btn-sm" onclick="approveUserPreference(<?php echo $record->id; ?>)"><i class="fa fa-check"></i></button>
												<?php
															}
														}
														?>

												<button class="btn btn-info btn-sm" onclick="loadUserPreferenceFormUIToView(<?php echo $record->id; ?>)"><i class="fa fa-eye"></i></button>
												<button class="btn btn-warning btn-sm" onclick="loadUserPreferenceFormUIToEdit(<?php echo $record->id; ?>)"><i class="fa fa-pencil"></i></button>
												...
												<?php if ($record->isApproved == "1") {
															?>
													<button class="btn btn-danger btn-sm" onclick="deleteUserPreference(<?php echo $record->id; ?>)"><i class="fa fa-trash"></i></button>
												<?php } ?>
											</div>
...
<script type="text/javascript">
	jQuery(document).ready(function() {
		jQuery('ul.pagination li a').click(function(e) {
			...
			//jQuery("#searchList").attr("action", baseURL + "userPreferenceList/" + value);
