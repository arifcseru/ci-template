<!-- /**
 * Class : interviewInfoList (interviewInfoForm List)
											...
											<div class="form-group">
												...
												<?php if ($role != null && $role == ROLE_APPROVER_ADMIN) {
													...
													<?php
																	...
																	?>
														<button class="btn btn-success btn-sm" onclick="approveInterviewInfo(<?php echo $record->id; ?>)"><i class="fa fa-check"></i></button>
												<?php
															}
														}
														?>
...
<script type="text/javascript">
	jQuery(document).ready(function() {
		jQuery('ul.pagination li a').click(function(e) {
			...
			//jQuery("#searchList").attr("action", baseURL + "interviewInfoList/" + value);
