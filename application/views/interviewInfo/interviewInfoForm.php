...
<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group bmd-form-group">
									...
									<input required="" type="text" class="form-control" id="interviewType" name="interviewType" value="<?php echo $interviewType; ?>" />
								</div>
							</div>
						</div>
<!-- Short Code -->
...
<div class="row">
					...
					if ($isApproved==null ||$isApproved=="" || $isApproved == "0") {
						?>
						<button onclick="saveInterviewInfo()" class="btn btn-success pull-right"><?php echo $this->lang->line('content_save_label'); ?></button>
						<button onclick="loadInterviewInfoListUI()" class='btn btn-warning pull-left'> <?php echo $this->lang->line('content_cancel_label'); ?></button>
					<?php
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<?php
									...
									?>
							<button class="btn btn-success" onclick="approveInterviewInfo(<?php echo $id; ?>)"><?php echo $this->lang->line('content_approve_label'); ?></button>
						<?php
								}
								?>
						<button class="btn btn-danger" onclick="deleteInterviewInfo(<?php echo $id; ?>)"><?php echo $this->lang->line('content_delete_label'); ?></button>
					</div>
