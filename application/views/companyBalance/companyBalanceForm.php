...
<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group bmd-form-group">
									...
									<input required="" type="text" class="form-control" id="initialBalance" name="initialBalance" value="<?php echo $initialBalance; ?>" />
								</div>
							</div>
						</div>
<!-- Current Balance -->
<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group bmd-form-group">
									...
									<input required="" type="text" class="form-control" id="currentBalance" name="currentBalance" value="<?php echo $currentBalance; ?>" />
								</div>
							</div>
						</div>
					<!-- Another Row -->
					...
					if ($isApproved==null ||$isApproved=="" || $isApproved == "0") {
						?>
						<button onclick="saveCompanyBalance()" class="btn btn-success pull-right"><?php echo $this->lang->line('content_save_label'); ?></button>
						<button onclick="loadCompanyBalanceListUI()" class='btn btn-warning pull-left'> <?php echo $this->lang->line('content_cancel_label'); ?></button>
					<?php
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<?php
									...
									?>
							<button class="btn btn-success" onclick="approveCompanyBalance(<?php echo $id; ?>)"><?php echo $this->lang->line('content_approve_label'); ?></button>
						<?php
								}
								?>
						<button class="btn btn-danger" onclick="deleteCompanyBalance(<?php echo $id; ?>)"><?php echo $this->lang->line('content_delete_label'); ?></button>
					</div>
