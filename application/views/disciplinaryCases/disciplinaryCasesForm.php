<!-- /**
 * Class : disciplinaryCasesForm (disciplinaryCasesForm View)
...
$isApproved = $disciplinaryCases->isApproved;
...
<div class="row">
	<div class="col-md-8">
		<div class="card">
			...
			<div class="card-body">
				<!-- form role="form" action="<?php echo base_url() ?>disciplinaryCases/create"
					method="post" id="createDisciplinaryCases" role="form"-->
...
<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group bmd-form-group">
									...
									<input required="" type="text" class="form-control" id="caseName" name="caseName" value="<?php echo $caseName; ?>" />
								</div>
							</div>
						</div>
<!-- Description -->
<div class="row">
					...
					if ($isApproved==null ||$isApproved=="" || $isApproved == "0") {
						?>
						<button onclick="saveDisciplinaryCases()" class="btn btn-success pull-right"><?php echo $this->lang->line('content_save_label'); ?></button>
						<button onclick="loadDisciplinaryCasesListUI()" class='btn btn-warning pull-left'> <?php echo $this->lang->line('content_cancel_label'); ?></button>
					<?php
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<?php
									...
									?>
							<button class="btn btn-success" onclick="approveDisciplinaryCases(<?php echo $id; ?>)"><?php echo $this->lang->line('content_approve_label'); ?></button>
						<?php
								}
								?>
						<button class="btn btn-danger" onclick="deleteDisciplinaryCases(<?php echo $id; ?>)"><?php echo $this->lang->line('content_delete_label'); ?></button>
					</div>
